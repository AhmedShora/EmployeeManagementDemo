   ...
   // [Authorize(Roles = "Admin")]
    ...
    public class AdministrationController : Controller
    {
      ...
      //  [Authorize(Policy = "EditRolePolicy")]
        ...
        //[Authorize(Roles = "Admin")]
        [HttpGet]
        public async Task<IActionResult> EditUsersIsInRole(string roleId)
        {
        ...
        [Authorize(Roles = "Admin")]
        [HttpPost]
        public async Task<IActionResult> EditUsersIsInRole(List<UserRoleViewModel> model, string roleId)
        {
            var role = await roleManager.FindByIdAsync(roleId);
